---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en CBIMA, CBIRT y los cantones Curridabat, La Unión, Montes de Oca y San José"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/corredores-cantones/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_corredores_cantones_parches_esenciales_importantes_migratorias/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_corredores_cantones_rutas_conectividad_migratorias/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.004527, 0.039531, 0.149749, 0.249210, Inf)
...
# Importancia
bins_importancia <- c(0, 1597446988620.00, 6411280869840.00, 20658255136000.00, 134712877812000.00, Inf)
